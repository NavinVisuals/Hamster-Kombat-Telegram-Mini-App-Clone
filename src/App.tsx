...
function App() {
  ...
  const levelNames = [
    ...
    "Lord",       // From 1,000,000,000 coins to 15,000,000,000 coins
    "Creator"    // From 15,000,000,000 coins to ∞
  ];
      ...
      <div className="w-full bg-black text-white h-screen font-bold flex flex-col max-w-xl">
        ...
        <div className="px-4 z-10">
          ...
          <div className="flex items-center space-x-2 pt-4">
            ...
            <div>
              <p className='text-sm'>Navin Joshi (CEO)</p>
            </div>
          </div>
